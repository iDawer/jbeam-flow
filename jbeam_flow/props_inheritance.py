...
class JbeamPropsInheritance(PropertyGroup, Table):
    """
...
class DATA_PT_jbeam(Panel):
    ...
    @staticmethod
    def register():
        Mesh.jbeam_node_prop_chain = PointerProperty(type=JbeamPropsInheritance)
        Mesh.jbeam_beam_prop_chain = PointerProperty(type=JbeamPropsInheritance)
        Mesh.jbeam_triangle_prop_chain = PointerProperty(type=JbeamPropsInheritance)
